...
void desenhar(void) {
    ...
    // Envie nossa transformação para o shader atualmente vinculado,
    // na uniforme "MVP"
    ...
    glVertexAttribPointer(
        0,                  // atributo 0. Não há razão particular para 0, mas deve corresponder ao layout no shader.
        3,                  // tamanho
        GL_FLOAT,           // tipo
        GL_FALSE,           // normalizado?
        0,                  // passo
        (void*)0            // deslocamento do buffer de array
    );
    ...
    glBindBuffer(GL_ARRAY_BUFFER, idBufferCores);
    glVertexAttribPointer(
        1,                                // atributo. Não há razão particular para 1, mas deve corresponder ao layout no shader.
        3,                                // tamanho
        GL_FLOAT,                         // tipo
        GL_FALSE,                         // normalizado?
        0,                                // passo
